...
/**
 * NOTE
 * Focus Income formula ( ( #2 * #3 * #4 ) + ( #40 * #3 * #4 ) ) - ( ( #5 * #2 ) + ( #26 * #3 * #2 ) + ( #26 * #3 * #40 ) )
 * Target = 9001,
 * Diversified = 9002
 */
export const yAxisFormula = {
  "#2": "( #9001 - #9002 + ( ( #5 * #2 ) + ( #26 * #3 * #2 ) + ( #26 * #3 * #40 ) ) )  / ( #4 * #3 )", // area
  "#40":
    "( #9001 - #9002 + ( ( #5 * #2 ) + ( #26 * #3 * #2 ) + ( #26 * #3 * #40 ) ) )  / ( #4 * #3 )", // animals
  "#3": "( #9001 - #9002 + ( ( #5 * #2 ) + ( #26 * #3 * #2 ) + ( #26 * #3 * #40 ) ) ) / ( ( #4 * #2 ) + ( #4 * #40 ) )", // volume
  "#4": "( #9001 - #9002 + ( ( #5 * #2 ) + ( #26 * #3 * #2 ) + ( #26 * #3 * #40 ) ) ) / ( ( #3 * #2 ) + ( #3 * #40 ) )", // price
  "#5": "( ( #9001 - #9002 ) - ( ( #2 * #4 * #3 ) + ( #40 * #4 * #3 ) ) ) / ( #2 + #40 )", // CoP for crop
  "#26":
    "( ( #9001 - #9002 ) - ( ( #2 * #4 * #3 ) + ( #40 * #4 * #3 ) ) ) / ( ( #3 * #2 ) + ( #3 * #40 ) )", // CoP for aqua n livestock
  "#9002":
    "( #9001 + ( ( #5 * #2 ) + ( #26 * #3 * #2 ) + ( #26 * #3 * #40 ) ) ) - ( ( #2 * #4 * #3 ) + ( #40 * #4 * #3 ) )", // diversified
};

        ...
        assert commodity_categories == [
            ...
            },
            {
                ...
                "commodities": [
                    ...
                    {"id": 1001, "name": "Tea"},
                    {"id": 1002, "name": "Wheat"},
                    {"id": 1003, "name": "Rice / Paddy"},
                    {"id": 1004, "name": "Cocoa"},
                    {"id": 1005, "name": "Maize"},
                    {"id": 1006, "name": "Cassava"},
                    {"id": 1010, "name": "Cotton"},
                    {"id": 1011, "name": "Sorghum"},
                    {"id": 1012, "name": "Pepper"},
                    {"id": 1013, "name": "Pineapple"},
                    {"id": 1014, "name": "Cashew"},
                    {"id": 1015, "name": "Macadamia"},
                    {"id": 1016, "name": "Mango"},
                    {"id": 1017, "name": "Oil palm (FFB)"},
                    {"id": 1019, "name": "Vanilla"},
                    {"id": 1020, "name": "Beans"},
                    {"id": 1021, "name": "Chilli"},
                    {"id": 1022, "name": "Fonio"},
                    {"id": 1023, "name": "Ginger"},
                    ...
                    {"id": 1027, "name": "Potato"},
                    {"id": 1028, "name": "Rubber"},
                    {"id": 1029, "name": "Sunflower"},
                    {"id": 1030, "name": "Tomato"},
                    {"id": 1031, "name": "Mint"},
                    {"id": 1032, "name": "Coriander"},
                    {"id": 1034, "name": "Turmeric"},
                    {"id": 1035, "name": "Vegetables"},
                    {"id": 1036, "name": "Soybean"},
                    {"id": 1037, "name": "Nuts"},
                    {"id": 1038, "name": "Black Pepper"},
                    {"id": 1039, "name": "Sugar snaps"},
                    {"id": 1040, "name": "Corn"},
                    {"id": 1045, "name": "Avocado"},
                    {"id": 1046, "name": "Fruit trees"},
                    {"id": 1047, "name": "Plantain"},
                ],
            },
            {
                "id": 101,
                "name": "Aquaculture",
                "commodities": [
                    {"id": 1007, "name": "Tilapia"},
                    {"id": 1033, "name": "Catfish"},
                    {"id": 1041, "name": "Shrimp"},
                    {"id": 1042, "name": "Salmon"},
                ],
            },
